namespace DAL.Repositories.Competition
{
    ...
    public class CompetitionAddressRepository : GenericRepository<AddressEntity, CompetitionContext>, IAddressRepository
    {
        public CompetitionAddressRepository(CompetitionContext context)
            : base(context)
        {
        }
