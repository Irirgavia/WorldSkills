...
export class PersonalData extends React.Component {
    ...
    render() {
        if (this.props.error) {
            ...
            return <div>
                <Redirect from="/judge/personaldata" to="/judge/personaldata/change" />
                <Redirect from="/participant/personaldata" to="/participant/personaldata/change" />
                <Redirect from="/trainer/personaldata" to="/trainer/personaldata/change" />
            </div>;
        }else {
            return <div class="personaldata">
                    <p>
